...
<div id="carouselExampleCaptions" class="carousel slide banner-section mt-4">
  ...
  <div class="carousel-inner">
    ...
    <!-- use slide_img class to manage custom height on the banner -->
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5><?php echo $hero_aria_canvar_offer_canvar_title_1; ?></h5>
        <p><?php echo $hero_aria_canvar_offer_canvar_sub_title_1; ?></p>
      </div>
    </div>
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5><?php echo $hero_aria_canvar_offer_canvar_title_2; ?></h5>
        <p><?php echo $hero_aria_canvar_offer_canvar_sub_title_2; ?></p>
      </div>
    </div>
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5><?php echo $hero_aria_canvar_offer_canvar_title_3; ?></h5>
        <p><?php echo $hero_aria_canvar_offer_canvar_sub_title_3; ?></p>
      </div>
    </div>
  </div>
