...
// include("inc/__cus_company_info.php");
...
//       setcookie('verified_cus_phone_no', '', time() - 3600);
...
<body>
    ...
    <h1 class="text-center mt-2 mb-4">Verify your phone no to signup</h1>
    ...
    <form action="verification.php" class="" id="show_number">
        ...
        <h1>varified phone no is <?php
                                    ...
                                    if (isset($_COOKIE['verified_cus_update_phone_no'])) {
                                        echo $_COOKIE['verified_cus_update_phone_no'];
                                    }
  ...
  const analytics = getAnalytics(app);
    ...
    <script src="cus_js/otp_update_cus.js" type="text/javascript"></script>
