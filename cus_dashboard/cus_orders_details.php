...
<main>
  ...
  <div class="container mb-4 mt-4">
    <!-- <div class="container">
    <button type="submit" class ="btn btn-primary">Go my orders</button>
    ...
    <div class="row">
      <div class="col-4">
   <a href="cus_orders.php"><button type="submit" class ="btn btn-outline-primary mb-4 btn-sm">Go my orders</button></a>
          ...
          <div class="container page rounded">
            <div class="estimated_dalivary_datetime text-center fs-4 pt-2">
              ...
              <div class="est_ord_dat_ti pb-3">
                <img src="<?php echo SITE_URL ?>img/fast-delivery.png" width="50px" height="50px" class="img-fluid bg-body-secondary rounded-circle" alt="" srcset="">
                <?php
            ...
            ?>
              ...
              <div class="container status_section pb-3">
                ...
                <div class="order_acpected mb-4 fs-5"><img src="<?php echo SITE_URL ?>img/post.png" width="50px" height="50px" class="img-fluid bg-secondary rounded-circle" alt="" srcset=""> Order accepted</div>
                <?php

                if ($order_packaging_status !== '' && $order_accepting_status == 'order accepted') {
                  $_SESSION['ord_pack_sta_ord_trac'] = 1;
                  echo '
                      <div class="pakaging_starts mb-4 fs-5"><img src="'.SITE_URL.'img/box.png" width="50px" height="50px" class="img-fluid bg-warning rounded-circle" alt="" srcset=""> ' . $order_packaging_status . '</div>
                      ';
                } else {
                  // echo '
                ...
                if ($courier_handing_status == !'' && $order_packaging_status !== '' && $order_accepting_status == 'order accepted') {
                  ...
                  if ($courier_handing_desc == '') {
                    echo '
    <div class="handed_on_courier fs-5 mb-4">  <img src="'.SITE_URL.'img/delivery-man.png" width="50px" height="50px" class="img-fluid bg-secondary rounded-circle" alt="" srcset=""> Order handed on courier</div>
    ...
    ';
                ...
                if ($order_status == 'completed' && $courier_handing_status == !'' && $order_packaging_status !== '' && $order_accepting_status == 'order accepted') {
                  echo '
<div class="delivared_on_customer fs-5 mb-3"><img src="'.SITE_URL.'img/delivery.png" width="50px" height="50px" class="img-fluid bg-body-secondary rounded-circle" alt="" srcset=""> Order has been delivared to the customer</div>
                ...
                <table class="table table-borderless">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="col-10"><?php echo product_currency_bdt_cus() .  $pri; ?></td>

                    </tr>
                    <tr>
                      <!-- <th scope="row">1</th> -->
                      <td class="col-10"> <span>Total Price:</span></td>
                      <td class="col-10"><?php echo product_currency_bdt_cus() .  $total_price ?></td>
                    ...
                    <tr>
                      ...
                      <td class="col-10"> <?php
                                          if ($order_status == 'completed' || $order_status == 'cancelled') {
                                            ...
                                            echo product_currency_bdt_cus() . $total_price;
                                          }
