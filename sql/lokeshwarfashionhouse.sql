...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2023 at 08:17 PM
...
INSERT INTO `products` (`product_id`, `product_name`, `product_desc`, `product_img`, `product_price`, `product_status`, `make_as_featured`, `product_added_datetime`) VALUES
...
INSERT INTO `settings` (`id`, `website_name`, `website_description`, `website_slogan`, `logo_img_upload`, `admin_photo`, `login_img`, `authors_name`, `authors_email`, `company_name`, `phone_no`, `active_theme`, `datetime`) VALUES
