...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 16, 2023 at 09:03 PM
...
(6, 'Lokeshwar Deb', 'lokeshwarfashionhouse@gmail.com', '$2y$10$oLzJ5rSj16QBJOD5YzPTSOmJ3fSCei9Vdp3CyRW0UIi1/CSngZ9HC', 4568, '', 'pink-room.jpg.jpeg', '2023-02-27 05:07:43', '4223', 'UNKNOWN', 'Windows 10', 'Computer', 'light-theme', 'Admin'),
...
(1034, '68', 'Lokeshwar Deb_check', 'lokeshwarfashionhouse@gmail.com', '01842843373', 'Bangladesh', '2023-07-17 00:17:34');
...
(16, 'Lokeshwar Deb', 'this is my description', 'lokeshwarfashionhouse@gmail.com', '1212', '$2y$10$HzzCM/RFnfe7kGCJrPrFoO26Ls6w67lZ4jI9OcK7O0kOPW8lH5HEu', 'hand-tshirt.png.jpeg', 'Bangladesh', '4118', 'UNKNOWN', 'Windows 10', 'Computer', 'Email Verified', '2023-03-30 04:06:33'),
...
(68, 'Lokeshwar Deb_check', '', 'lokeshwarfashionhouse@gmail.com', '01842843373', '$2y$10$t3ZRGqQ27ZDinHYa/0d3qOkFqkxi0qwtu2KaoXc5Us2fPlCxjZfpK', '', 'Bangladesh', '6609', '::1', 'Windows 10', 'Computer', 'Email Verified', '2023-07-17 00:17:34');
...
CREATE TABLE `page_settings` (
  ...
  `hero_aria_canvar_offer_canvar_title_1` varchar(255) NOT NULL,
  `hero_aria_canvar_offer_canvar_title_2` varchar(255) NOT NULL,
  `hero_aria_canvar_offer_canvar_title_3` varchar(255) NOT NULL,
  `hero_aria_canvar_offer_canvar_sub_title_1` varchar(255) NOT NULL,
  `hero_aria_canvar_offer_canvar_sub_title_2` varchar(255) NOT NULL,
  `hero_aria_canvar_offer_canvar_sub_title_3` varchar(255) NOT NULL,
  `datetime` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `page_settings` (`id`, `hero_aria_bold_word`, `hero_aria_offer_title`, `hero_aria_offer_title_photo`, `hero_aria_offer_canvas_img1`, `hero_aria_offer_canvas_img2`, `hero_aria_offer_canvas_img3`, `hero_aria_canvar_offer_canvar_title_1`, `hero_aria_canvar_offer_canvar_title_2`, `hero_aria_canvar_offer_canvar_title_3`, `hero_aria_canvar_offer_canvar_sub_title_1`, `hero_aria_canvar_offer_canvar_sub_title_2`, `hero_aria_canvar_offer_canvar_sub_title_3`, `datetime`) VALUES
(1, 'N', 'ew Sale !', 'lokfahou-banner.jpg.jpeg', '20268.jpg.jpeg', 'new linkedin banner lokeshwar deb1.png.jpeg', 'Brown Minimalist Fashion Product Banner.png.jpeg', 'The Best T-shirt', 'The Best T-shirt2', 'The Best T-shirt3', 'Get the most fashionable T-shirts', 'Get the most fashionable T-shirts2', 'Get the most fashionable T-shirts3', '2023-05-17 18:13:30');
...
CREATE TABLE `settings` (
  ...
  `website_twitter_account` varchar(255) NOT NULL,
  `website_instragram_account` varchar(255) NOT NULL,
  `website_linkedin_account` varchar(255) NOT NULL,
  `active_theme` varchar(255) NOT NULL,
  `datetime` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `settings` (`id`, `website_name`, `website_description`, `website_contract_email`, `website_slogan`, `product_currency`, `logo_img_upload`, `admin_photo`, `login_img`, `users_login_img`, `authors_name`, `authors_email`, `company_name`, `phone_no`, `website_facebook_page`, `website_twitter_account`, `website_instragram_account`, `website_linkedin_account`, `active_theme`, `datetime`) VALUES
...
--
ALTER TABLE `customers`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1035;
