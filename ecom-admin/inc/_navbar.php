...
$theme_result = mysqli_query($conn, $sql_theme);
if($theme_result){
  if(mysqli_num_rows($theme_result)>0){
while($theme_row = mysqli_fetch_assoc($theme_result)){
$active_theme = $theme_row['active_theme'];
}
  }
}
...
// echo " " . $active_theme . " ";
              ...
              // echo $active_theme; 
              // if ($active_theme == 'dark_theme') {
              //   $_SESSION['theme'] = 'dark-theme';
              //   echo 'light-theme';
              // } elseif ($active_theme == 'light_theme') {
              ...
              if ($active_theme == 'light-theme') {
                // echo 'light-theme';
               $_SESSION['active_theme'] = 'light-theme';
               ...
               echo $_SESSION['active_theme'];
                ...
                // echo 'dark-theme';
                 $_SESSION['active_theme'] = 'dark-theme';
                 echo $_SESSION['active_theme'];
              }
...
<!-- short link section ends here -->

  <!-- big link section starts here -->
    <h1 class="visually-hidden">Sidebars examples</h1>
    <div class="row sticky-top big-link" id="bigCloseItem" class="">


      <div class="col-4 d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
      ...
      <div class="mx-2">
        ...
        <button type="submit" name="ChangeIcons" class="btn btn-dark"><i class="fa-solid  <?php
        ...
        ?>" id="sun" onclick="changeIcon(this)"></i>
        </button>
        </form>
      </div>
      ...
      if (isset($_POST['icons'])) {
        // if (isset($active_theme) == 'light-theme') {
        //   // echo 'light-theme';
        //   $_SESSION['active_theme'] = 'light-theme';
        // }

        // if (isset($active_theme) == 'dark_theme') {
        //   // echo 'dark-theme';
        //   $_SESSION['active_theme'] = 'dark-theme';
        // }
    ...
    <div class="dropdown <?php if ($active_class == 'add admin') {
      ...
      <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
        <img src="<?php echo $_SESSION['admin_photo'] ?>" alt="" width="32" height="32" class="rounded-circle me-2">
    ...
    <div class="b-example-divider" id="bigLinkDivider"></div>


    <div class="little-link sticky-top d-flex flex-column flex-shrink-0 bg-dark no-disp " style="width: 4.5rem;" id="smallCloseItem">
    <a href="home.php" class="d-block p-3 link-dark text-decoration-none" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Icon-only">
    <img src="<?php echo 'uploaded_img/' . $website_logo ?>" class="img-fluid" alt="" srcset="">
    </a>
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
      <li class="nav-item">
        <a href="home.php" class="nav-link text-light  py-3 border-bottom rounded-0 <?php if ($active_class == "home") {
                                                              echo 'active';
                                                            } ?>" aria-current="page" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Home" data-bs-original-title="Home">
          <svg class="bi pe-none" width="24" height="24" role="img" aria-label="Home"><use xlink:href="#home"></use></svg>
        </a>
      </li>
      <li>
        <a href="dashboard.php" class="nav-link  text-light py-3 border-bottom rounded-0 <?php if ($active_class == "dashboard") {
                                                              echo 'active';
                                                            } ?>" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Dashboard" data-bs-original-title="Dashboard">
          <svg class="bi pe-none" width="24" height="24" role="img" aria-label="Dashboard"><use xlink:href="#speedometer2"></use></svg>
        </a>
      </li>
      <li>
        <a href="orders.php"class="nav-link text-light  py-3 border-bottom rounded-0 <?php if ($active_class == "orders") {
                                                          echo 'active';
      ...
      <li>
        <a href="products.php" class="nav-link text-light py-3 border-bottom rounded-0 <?php if ($active_class == "products") {
                                                            echo 'active';
                                                          } ?>" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Products" data-bs-original-title="Products">
          <svg class="bi pe-none" width="24" height="24" role="img" aria-label="Products"><use xlink:href="#grid"></use></svg>
        </a>
      </li>
      <li>
        <a href="customers.php" class="nav-link text-light py-3 border-bottom rounded-0 <?php if ($active_class == "customers") {
                                                              echo 'active';
                                                            } ?>" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Customers" data-bs-original-title="Customers">
