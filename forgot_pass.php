...
<body>
    ...
    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" id="fp_forgot_form" class="container">
        ...
        <a href="index.php"><button type="submit" class="btn btn-outline-primary mb-4">Back to home</button></a>
...
$_SESSION['cus_fp_username'] = $fp_username;


    include "inc/conn.php";

    $fp_sql = "SELECT * FROM `cus_users` WHERE `cus_username` = '$fp_username'";
...
$add_otp = "UPDATE `cus_users` SET `otp` = '$otp' WHERE `cus_users`.`cus_username` = '$fp_username';";
